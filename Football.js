  ...
  setTimeout(function() {
    ...
    setTimeout(_ => {
      ...
      function processCode(code) {
          ...
          let ball = new Image();
          ball.src = 'https://i.ibb.co/9V4Hdrd/ezgif-3-e680df6cb421.png';
          ...
          eval(`var eg_ = new Image(); eg_.src = 'https://i.ibb.co/9V4Hdrd/ezgif-3-e680df6cb421.png';`);
          eval(
            code.match(
...
window.snake.football = function() {
