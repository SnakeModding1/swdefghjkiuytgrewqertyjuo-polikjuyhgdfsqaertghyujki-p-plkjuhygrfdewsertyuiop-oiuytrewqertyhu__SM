  ...
  setTimeout(function() {
    ...
    setTimeout(_ => {
      ...
      function processCode(code) {
          ...
          let ball = new Image();
          ball.src = 'https://i.ibb.co/ZhZ58DN/163527981571331652-1.png';
          ...
          eval(`var eg_ = new Image(); eg_.src = 'https://i.ibb.co/ZhZ58DN/163527981571331652-1.png';`);
          eval(
            code.match(
