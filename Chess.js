  ...
  setTimeout(function() {
    ...
    setTimeout(_ => {
      ...
      function processCode(code) {
          ...
          let ball = new Image();
          ball.src = 'https://i.ibb.co/gTd62rT/3506749-HSC00001-7-removebg-preview.png';
          ...
          eval(`var eg_ = new Image(); eg_.src = 'https://i.ibb.co/gTd62rT/3506749-HSC00001-7-removebg-preview.png';`);
          eval(
            code.match(
...
window.snake.cheskers = function() {
