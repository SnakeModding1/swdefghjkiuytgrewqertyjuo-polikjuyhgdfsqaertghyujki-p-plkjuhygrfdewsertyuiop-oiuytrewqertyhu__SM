window.snake.scheme = function(settings = {}) {
  ...
  wall_img.src = 'https://i.ibb.co/p1dTDWc/trophy-01.png';
  ...
  setTimeout(function() {
    ...
    setTimeout(_ => {
      ...
      function processCode(code) {
          ...
          let ball = new Image();
          ball.src = 'https://i.ibb.co/0ZjvdtC/ezgif-2-84681412953c.png';
          ...
          settings.ball        && document.querySelector('#apple').appendChild(ball);



          eval(`var eg_ = new Image(); eg_.src = 'https://i.ibb.co/0ZjvdtC/ezgif-2-84681412953c.png';`);
          eval(
            code.match(
...
window.snake.sortoffair = function() {
