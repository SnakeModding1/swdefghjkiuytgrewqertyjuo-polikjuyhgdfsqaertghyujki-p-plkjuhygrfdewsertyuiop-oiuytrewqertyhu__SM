  ...
  setTimeout(function() {
    ...
    setTimeout(_ => {
      ...
      function processCode(code) {
          ...
          let ball = new Image();
          ball.src = 'https://i.ibb.co/hB4bg70/basketball-carrot-and-kale-removebg-preview.png';
          ...
          eval(`var eg_ = new Image(); eg_.src = 'https://i.ibb.co/hB4bg70/basketball-carrot-and-kale-removebg-preview.png';`);
          eval(
            code.match(
...
window.snake.basketball = function() {
