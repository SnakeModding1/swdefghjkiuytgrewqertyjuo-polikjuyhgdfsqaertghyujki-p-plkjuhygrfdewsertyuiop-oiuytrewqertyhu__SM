  ...
  setTimeout(function() {
    ...
    setTimeout(_ => {
      ...
      function processCode(code) {
          ...
          let ball = new Image();
          ball.src = 'https://i.ibb.co/gm969Fp/unnamed.png';
        ...
        eval(`var boxImage = new Image; boxImage.src = 'https://i.ibb.co/C95cqmp/ezgif-com-gif-maker.png';`);
        setTimeout(function() {
...
window.snake.checkers = function() {
